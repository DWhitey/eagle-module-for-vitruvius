 ...
 * <!-- end-user-doc -->
 * @see eaglemodel.EaglemodelPackage#getContactRoute()
 * @model
 * @generated
 */
public enum ContactRoute implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<ContactRoute> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
