 ...
 * @generated
 */
public class ClearanceImpl extends MinimalEObjectImpl.Container implements Clearance {
	/**
	...
	public void setClass(int newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CLEARANCE__CLASS, oldClass, class_));
	}
	...
	public void setValue(double newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CLEARANCE__VALUE, oldValue, value));
	}
