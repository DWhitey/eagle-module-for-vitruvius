 ...
 * </p>
 * <ul>
 *   <li>{@link eaglemodel.impl.LayersImpl#getLayers <em>Layers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LayersImpl extends MinimalEObjectImpl.Container implements Layers {
	...
	protected EClass eStaticClass() {
		return EaglemodelPackage.Literals.LAYERS;
	}
	...
	public EList<Layer> getLayers() {
		if (layers == null) {
			layers = new EObjectContainmentEList<Layer>(Layer.class, this, EaglemodelPackage.LAYERS__LAYERS);
		}
		return layers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EaglemodelPackage.LAYERS__LAYERS:
