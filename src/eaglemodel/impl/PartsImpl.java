 ...
 * </p>
 * <ul>
 *   <li>{@link eaglemodel.impl.PartsImpl#getPart <em>Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PartsImpl extends MinimalEObjectImpl.Container implements Parts {
	...
	protected EClass eStaticClass() {
		return EaglemodelPackage.Literals.PARTS;
	}
	...
	public EList<Part> getPart() {
		if (part == null) {
			part = new EObjectContainmentEList<Part>(Part.class, this, EaglemodelPackage.PARTS__PART);
		}
		return part;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EaglemodelPackage.PARTS__PART:
