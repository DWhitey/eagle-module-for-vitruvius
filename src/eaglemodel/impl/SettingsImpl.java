 ...
 * </p>
 * <ul>
 *   <li>{@link eaglemodel.impl.SettingsImpl#getSettings <em>Settings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SettingsImpl extends MinimalEObjectImpl.Container implements Settings {
	...
	protected EClass eStaticClass() {
		return EaglemodelPackage.Literals.SETTINGS;
	}
	...
	public EList<Setting> getSettings() {
		if (settings == null) {
			settings = new EObjectContainmentEList<Setting>(Setting.class, this, EaglemodelPackage.SETTINGS__SETTINGS);
		}
		return settings;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EaglemodelPackage.SETTINGS__SETTINGS:
