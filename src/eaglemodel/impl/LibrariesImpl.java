 ...
 * </p>
 * <ul>
 *   <li>{@link eaglemodel.impl.LibrariesImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LibrariesImpl extends MinimalEObjectImpl.Container implements Libraries {
	...
	protected EClass eStaticClass() {
		return EaglemodelPackage.Literals.LIBRARIES;
	}
	...
	public EList<Library> getLibrary() {
		if (library == null) {
			library = new EObjectContainmentEList<Library>(Library.class, this, EaglemodelPackage.LIBRARIES__LIBRARY);
		}
		return library;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EaglemodelPackage.LIBRARIES__LIBRARY:
