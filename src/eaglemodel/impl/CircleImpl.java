 ...
 *   <li>{@link eaglemodel.impl.CircleImpl#getRadius <em>Radius</em>}</li>
...
public class CircleImpl extends MinimalEObjectImpl.Container implements Circle {
	...
	protected EClass eStaticClass() {
		return EaglemodelPackage.Literals.CIRCLE;
	}
	...
	public void setX(double newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CIRCLE__X, oldX, x));
	}
	...
	public void setY(double newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CIRCLE__Y, oldY, y));
	}
	...
	public void setRadius(double newRadius) {
		...
		radius = newRadius;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CIRCLE__RADIUS, oldRadius, radius));
	}
	...
	public void setWidth(double newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CIRCLE__WIDTH, oldWidth, width));
	}
	...
	public void setLayer(int newLayer) {
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EaglemodelPackage.CIRCLE__LAYER, oldLayer, layer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EaglemodelPackage.CIRCLE__X:
				return new Double(getX());
			case EaglemodelPackage.CIRCLE__Y:
				return new Double(getY());
			case EaglemodelPackage.CIRCLE__RADIUS:
				return new Double(getRadius());
			case EaglemodelPackage.CIRCLE__WIDTH:
				return new Double(getWidth());
			case EaglemodelPackage.CIRCLE__LAYER:
