 ...
 * <!-- end-user-doc -->
 * @see eaglemodel.EaglemodelPackage#getPinVisible()
 * @model
 * @generated
 */
public enum PinVisible implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<PinVisible> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
